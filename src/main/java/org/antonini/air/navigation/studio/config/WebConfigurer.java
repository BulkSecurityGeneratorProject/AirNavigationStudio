...
import org.antonini.air.navigation.studio.web.filter.CachingHttpHeadersFilter;
import org.antonini.air.navigation.studio.web.filter.StaticResourcesProductionFilter;
import org.antonini.air.navigation.studio.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "AirNavigationStudio");
