...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AirNavigationStudio@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AirNavigationStudio API";

        private String description = "AirNavigationStudio API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AirNavigationStudio";
